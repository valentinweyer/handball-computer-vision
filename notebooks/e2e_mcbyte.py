...
OUTPUT_VIDEO      = SOURCE_VIDEO_PATH.parent / f"{SOURCE_VIDEO_PATH.stem}-mcbyte-map-side.mp4"
OUTPUT_COMPRESSED = SOURCE_VIDEO_PATH.parent / f"{SOURCE_VIDEO_PATH.stem}-mcbyte-map-side-compressed.mp4"
...
TEAM_CALIBRATION_CACHE = Path(os.getenv(
    "TEAM_CALIBRATION",
    SOURCE_VIDEO_PATH.parent / f".{SOURCE_VIDEO_PATH.stem}_prototype_team.pkl",
))
