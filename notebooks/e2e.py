...
# `from sam2...`.
sys.path.insert(
    0, "/home/valentinweyer/projects/handball-computer-vision/sam2-upstream"
)
...
FRAME_CACHE_DIR   = SOURCE_VIDEO_PATH.parent / f".{SOURCE_VIDEO_PATH.stem}_frames"
...
SAM2_CHECKPOINT = str(
    Path("/home/valentinweyer/projects/handball-computer-vision/segment-anything-2-real-time")
