...
RUN_DIR = SOURCE_VIDEO_PATH.parent / ".runs"
MASK_CACHE_DIR = SOURCE_VIDEO_PATH.parent / f".{SOURCE_VIDEO_PATH.stem}_sam2_masks"
LABELS_PATH = SOURCE_VIDEO_PATH.parent / f".{SOURCE_VIDEO_PATH.stem}_team_labels.json"
LABEL_PAGE_PATH = SOURCE_VIDEO_PATH.parent / "team_classification_examples" / "label_teams.html"
...
SHEET_DIR = SOURCE_VIDEO_PATH.parent / "team_classification_examples"
SHEET_ORDER_PATH = SOURCE_VIDEO_PATH.parent / f".{SOURCE_VIDEO_PATH.stem}_label_sheet_order.json"
GRID_COLS = 5
